  ...
  return (
    ...
    >
      <div className="pointer-events-none absolute inset-0">
        <div className="absolute -right-8 -top-8 h-40 w-40 rounded-full bg-[#1dff00]/10 blur-3xl" />
        <div className="absolute -bottom-10 -left-10 h-44 w-44 rounded-full bg-violet-500/10 blur-3xl" />
      </div>

      <div className="relative z-10">
        <div className="mb-3 flex flex-wrap items-center gap-2">
          <span className="rounded-full border border-[#1dff00]/35 bg-[#1dff00]/10 px-2.5 py-0.5 text-[10px] font-semibold uppercase tracking-wide text-[#1dff00]">
        ...
        <div className="mb-2 flex items-start gap-2">
          <div className="mt-0.5 rounded-lg bg-[#1dff00]/15 p-2">
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-foreground/60">
              ...
              score drivers, and interview angles. You’re seeing a short
              preview only.
            </p>
          </div>
        </div>
        ...
        <div className="relative mt-4 rounded-xl border border-foreground/10 bg-foreground/[0.03] p-4">
          <p className="text-sm leading-relaxed text-foreground/85">{snippet}</p>
          <div
          ...
          <div
            ...
            style={{ maskImage: "linear-gradient(to bottom, transparent 0%, black 55%)" }}
            aria-hidden
          />
        ...
        <div className="mt-5 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
          ...
          <Link to="/dashboard/billing" className="shrink-0">
            <Button className="w-full bg-gradient-to-r from-[#1dff00] to-[#1dff00]/85 font-semibold text-black hover:from-[#1dff00]/90 sm:w-auto">
