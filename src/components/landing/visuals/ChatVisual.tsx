...
export const ChatVisual = () => {
  return (
    <div className="w-full h-full p-4 flex flex-col justify-end space-y-3 font-mono text-xs overflow-hidden">
      ...
      >
        <div className="w-6 h-6 rounded-full bg-[#2dd4bf]/10 border border-[#2dd4bf]/30 flex items-center justify-center shrink-0">
          <Bot className="w-3 h-3 text-[#2dd4bf]" />
        </div>
        <div className="bg-[#2dd4bf]/5 border border-[#2dd4bf]/10 p-2 rounded-l-lg rounded-br-lg text-[#2dd4bf] max-w-[85%]">
      ...
      >
        ...
        <div className="bg-[#2dd4bf]/5 border border-[#2dd4bf]/10 px-3 py-2 rounded-l-lg rounded-br-lg flex space-x-1 items-center">
            <motion.div
              animate={{ opacity: [0.3, 1, 0.3] }}
              transition={{ repeat: Infinity, duration: 1, delay: 0 }}
              className="w-1 h-1 bg-[#2dd4bf] rounded-full"
            />
            <motion.div
              animate={{ opacity: [0.3, 1, 0.3] }}
