  ...
  return (
    <div className='w-full h-full min-h-[200px] flex items-center justify-center relative overflow-hidden bg-background'>
      ...
      <div
        ...
        style={{
          backgroundImage: "radial-gradient(#2fd968 1px, transparent 1px)",
      ...
      <div className='relative z-10'>
        ...
        />
        <div className='w-12 h-12 rounded-full border-2 border-brand flex items-center justify-center relative bg-black z-20 shadow-[0_0_15px_rgba(47,217,104,0.3)]'>
