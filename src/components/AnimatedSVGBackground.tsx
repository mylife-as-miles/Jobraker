      ...
      >
        <defs>
          ...
          <linearGradient
            ...
            y2='100%'
          >
            <stop offset='0%' stopColor='#2fd968' stopOpacity='0.1'>
              <animate
            ...
            <stop offset='100%' stopColor='#2fd968' stopOpacity='0.05'>
              <animate
                attributeName='stop-opacity'
      ...
      >
        ...
        <defs>
          <linearGradient id='wave-gradient' x1='0%' y1='0%' x2='100%' y2='0%'>
            <stop offset='0%' stopColor='#2fd968' />
            <stop offset='100%' stopColor='#2fd968' />
          </linearGradient>
        </defs>
      </svg>
