...
export const CreditDisplay = () => {
  ...
  const getTierColor = () => {
    switch (subscriptionTier) {
      ...
      default:
        ...
        return 'from-[#22d3ee] to-background';
    }
  };
  ...
  return (
    <button
      ...
      className={`flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-1.5 sm:py-2 rounded-xl bg-gradient-to-r ${getTierColor()} hover:opacity-90 transition-all duration-300 hover:scale-105 cursor-pointer shadow-[0_0_0_1px_#2dd4bf,0_4px_16px_rgba(45,212,191,0.3)] hover:shadow-[0_0_0_1px_#2dd4bf,0_6px_24px_rgba(45,212,191,0.5)]`}
