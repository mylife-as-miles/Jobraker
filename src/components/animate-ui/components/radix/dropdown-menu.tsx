...
function DropdownMenuContent({
  ...
  return (
    <DropdownMenuContentPrimitive
      ...
      {...props}
    >
      <DropdownMenuHighlightPrimitive className=" absolute inset-0 z-0 rounded-xl bg-[#ffd700]/18 opacity-0 transition-opacity duration-300 data-[active=true]:opacity-100">
        {children}
    ...
    <DropdownMenuHighlightItemPrimitive disabled={disabled}>
      <DropdownMenuItemPrimitive
        ...
        className={cn(
          ...
          "data-[highlighted=true]:text-[#ffd700] data-[state=open]:text-[#ffd700]",
    ...
    <DropdownMenuHighlightItemPrimitive disabled={disabled}>
      <DropdownMenuCheckboxItemPrimitive
        ...
        className={cn(
          ...
          "data-[highlighted=true]:text-[#ffd700]",
    ...
    <DropdownMenuHighlightItemPrimitive>
      <DropdownMenuSubTriggerPrimitive
        ...
        className={cn(
          ...
          'data-[state=open]:text-[#ffd700] data-[highlighted=true]:text-[#ffd700]',
