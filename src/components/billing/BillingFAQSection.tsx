        ...
        <CardHeader className="border-b border-foreground/10 bg-foreground/[0.02] pb-6">
          <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
            <div className="flex gap-3">
              <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl border border-[#2dd4bf]/25 bg-[#2dd4bf]/10">
                <HelpCircle className="h-5 w-5 text-[#2dd4bf]" aria-hidden />
              </div>
              <div>
              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    <ChevronDown
                      className={`h-5 w-5 shrink-0 text-[#2dd4bf] transition-transform duration-200 ${
                        isOpen ? "rotate-180" : ""
                      }`}
                      aria-hidden
                    />
