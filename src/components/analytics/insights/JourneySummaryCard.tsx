  ...
  return (
    ...
    >
      <Card className="relative h-full overflow-hidden border border-border/40 bg-card/40 backdrop-blur-xl shadow-2xl transition-all duration-300">
        ...
        <div className="absolute -top-24 -right-24 w-64 h-64 rounded-full bg-[#06b6d4]/5 blur-3xl" />
        <div className="absolute -bottom-24 -left-24 w-64 h-64 rounded-full bg-[#06b6d4]/5 blur-3xl" />

        <div className="relative z-10 flex h-full flex-col p-5 sm:p-6">
          {/* Header */}
          <div className="mb-6 space-y-3">
            <div className="inline-flex items-center gap-2 rounded-full border border-[#06b6d4]/25 bg-[#06b6d4]/10 px-3 py-1 text-[10px] font-bold uppercase tracking-[0.15em] text-[#06b6d4]">
            ...
            {hasData ? (
              <div className="rounded-2xl border border-border/30 bg-background/30 p-5 backdrop-blur-sm">
                <div className="relative">
                  <span className="absolute -top-2 -left-1 text-3xl font-serif text-[#06b6d4]/30">
                    &ldquo;
                  </span>
                  <p className="pl-4 text-base leading-relaxed text-foreground/85 italic">
                    {narrative}
                  </p>
                  <span className="absolute -bottom-4 right-0 text-3xl font-serif text-[#06b6d4]/30">
                    &rdquo;
                  </span>
                </div>
              </div>
            ...
            {loading && (
              <div className="absolute inset-0 flex items-center justify-center rounded-2xl bg-background/60 backdrop-blur-xl transition-all duration-500">
                <div className="flex items-center gap-3 rounded-full border border-border/40 bg-card/80 px-5 py-2.5 text-xs font-medium text-foreground/80 shadow-2xl backdrop-blur-md">
                  <div className="h-4 w-4 animate-spin rounded-full border-2 border-[#06b6d4]/20 border-t-[#06b6d4]" />
