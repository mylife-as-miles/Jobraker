        ...
        <div className="flex h-full flex-col p-5 sm:p-6">
          <div className="mb-5 flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
            <div className="space-y-3">
              <div className="inline-flex items-center gap-2 rounded-full border border-[#2dd4bf]/25 bg-[#2dd4bf]/10 px-3 py-1 text-xs font-semibold uppercase tracking-[0.2em] text-[#2dd4bf]">
            ...
            {hasData ? (
              <ResponsiveContainer width="100%" height="100%">
                <AreaChart data={combinedSeries} margin={{ top: 8, right: 8, left: -16, bottom: 0 }}>
                  ...
                  <Line type="monotone" dataKey="applications" name="Applications" stroke="#2dd4bf" strokeWidth={3} dot={{ r: 3, fill: "#2dd4bf" }} activeDot={{ r: 5 }} />
                </AreaChart>
              </ResponsiveContainer>
            ) : (
