  ...
  return (
    <div className="space-y-4 sm:space-y-6 lg:space-y-8">
      ...
      <div className="grid grid-cols-2 gap-3 md:grid-cols-4 md:gap-4">
        ...
        <button type="button" onClick={() => gotoApplications("Interview")} className="rounded-2xl border border-border bg-card/85 p-4 text-left transition hover:border-[#56c2ff]/35 hover:bg-card">
          <div className="mb-3 flex items-center justify-between">
            <span className="text-xs font-medium uppercase tracking-wide text-foreground/55">Interviews</span>
            <div className="rounded-full bg-[#56c2ff]/10 p-2 text-[#56c2ff]"><CalendarCheck className="h-4 w-4" /></div>
          </div>
          <div className="flex items-end justify-between gap-2">
            <div className="text-3xl font-bold text-foreground">{metrics.interviews}</div>
        ...
        <div className="rounded-2xl border border-border bg-card/85 p-4">
          <div className="mb-3 flex items-center justify-between">
            <span className="text-xs font-medium uppercase tracking-wide text-foreground/55">Sources</span>
            <div className="rounded-full bg-foreground/10 p-2 text-foreground/75"><Layers className="h-4 w-4" /></div>
          </div>
          <div className="flex items-end justify-between gap-2">
            <div className="text-3xl font-bold text-foreground">{metrics.sources}</div>
