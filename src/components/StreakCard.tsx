...
export const StreakCard = ({
  ...
  return (
    <motion.div
      ...
      className="relative overflow-hidden min-h-[200px] sm:min-h-[220px] rounded-xl border border-foreground/10 bg-gradient-to-br from-foreground/10 via-foreground/5 to-foreground/0 backdrop-blur-[25px] shadow-xl hover:shadow-2xl hover:border-[#1dff00]/50 hover:shadow-[#1dff00]/20 transition-all duration-500"
    >
      ...
      <div className="relative z-10 p-4 sm:p-5 h-full flex flex-col">
        ...
        <div className="flex items-center gap-1.5 sm:gap-2 mt-auto">
          ...
          <motion.div
            ...
            className="flex-1 bg-foreground/[0.04] border border-foreground/[0.08] rounded-lg p-2 sm:p-2.5 hover:border-[#1dff00]/40 hover:bg-[#1dff00]/5 transition-all duration-300"
          >
