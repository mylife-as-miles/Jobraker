...
export const TooltipContent: React.FC<React.HTMLAttributes<HTMLDivElement>> = ({children, className = '', ...rest}) => (
	<div
		role="tooltip"
		className={
			"z-50 rounded-xl border border-foreground/15 bg-background/80 px-2.5 py-1.5 text-xs text-white shadow-[0_10px_30px_-10px_rgba(255,215,0,0.25)] backdrop-blur-md " +
