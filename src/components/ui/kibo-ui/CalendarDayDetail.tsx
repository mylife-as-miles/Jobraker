          ...
          >
            ...
            >
              <div
                ...
                style={{
                  background:
                    "radial-gradient(circle at 30% 20%, rgba(47,217,104,0.08), transparent 60%)",
                }}
              />
              <button
                onClick={onClose}
      ...
      >
        <div className='space-y-4 p-1'>
          ...
          <div className='flex justify-end gap-2'>
            ...
            <Button
              className='bg-gradient-to-r from-brand to-background text-black font-semibold hover:shadow-[0_0_20px_rgba(47,217,104,0.3)]'
              onClick={async () => {
