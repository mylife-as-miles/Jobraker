...
export const Gantt: React.FC<GanttProps> = ({
  ...
  return (
    <div
      ref={scrollRef}
      className={
        "relative w-full overflow-auto rounded-2xl border border-brand/20 bg-gradient-to-br from-background via-background to-background backdrop-blur-xl shadow-[0_0_30px_rgba(22,163,74,0.15)] " +
        className
      }
        ...
        <div className='flex items-stretch'>
          <div className='w-64 flex items-center justify-between gap-3 px-4 py-3 border-r border-brand/20'>
            <div className='flex items-center gap-2'>
              <div className='h-2 w-2 rounded-full bg-brand shadow-[0_0_8px_rgba(22,163,74,0.6)]' />
        ...
        {min && max && (
          <div className='absolute inset-y-0 left-64 right-0 pointer-events-none select-none'>
            ...
            {showTodayMarker && (
              ...
              >
                <div className='h-full w-[2px] bg-gradient-to-b from-brand via-brand/80 to-brand/20 shadow-[0_0_8px_rgba(22,163,74,0.5)]' />
                        ...
                        >
                          ...
                          >
                            <div className='relative h-full'>
                              ...
                              <div
                                className='absolute group rounded-lg overflow-hidden ring-1 ring-white/10 shadow-md hover:ring-brand/40 hover:shadow-[0_0_20px_rgba(22,163,74,0.2)] transition-all duration-300 cursor-pointer focus:outline-none focus:ring-2 focus:ring-brand/60 transform hover:scale-[1.02]'
                                style={{
                                  left: `${left}%`,
                                  width: widthPct + "%",
                                  top: height * 0.25,
                              ...
                              >
                                ...
                                {/* Enhanced Tooltip */}
                                <div className='absolute z-30 hidden group-hover:flex -top-3 left-1/2 -translate-y-full -translate-x-1/2 min-w-[220px] max-w-[280px] flex-col rounded-xl border border-brand/30 bg-gradient-to-br from-background to-background backdrop-blur-xl p-3 shadow-[0_0_30px_rgba(22,163,74,0.2)]'>
...
function statusColor(status?: string): { bg: string; fg: string } {
  switch (status) {
    ...
    case "Applied":
      return { bg: "linear-gradient(90deg,#16a34a,#16a34a)", fg: "#041f11" };
    case "Failed":
      return { bg: "linear-gradient(90deg,#f97316,#ea580c)", fg: "#1a0a00" };
    case "Terminated":
      return { bg: "linear-gradient(90deg,#e11d48,#9f1239)", fg: "#fff1f2" };
    case "Interview":
      return { bg: "linear-gradient(90deg,#16a34a,#16a34a)", fg: "#2d1e04" };
    case "Offer":
      return { bg: "linear-gradient(90deg,#84cc16,#166534)", fg: "#0b1f0f" };
    case "Rejected":
      return { bg: "linear-gradient(90deg,#fb7185,#16a34a)", fg: "#2f070f" };
    case "Withdrawn":
...
export const GanttToday: React.FC = () => {
  ...
  return (
    <div
      ...
      style={{ left: p + "%" }}
    >
      <div className='h-full w-px bg-brand shadow-[0_0_0_1px_rgba(22,163,74,0.4)]' />
