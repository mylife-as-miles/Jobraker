    ...
    >
      ...
      {showLegend && (
        <div className='mb-3 flex flex-wrap gap-2 text-[10px] sm:text-xs'>
          ...
          {heatmap && (
            <span className='inline-flex items-center gap-1.5 rounded-full border border-brand/20 bg-brand/10 px-3 py-1 text-brand shadow-[0_0_24px_rgba(34,197,94,0.08)]'>
          ...
          return (
            <button
              ...
              className={[
                ...
                isToday
                  ? "!border-brand/25 !bg-[linear-gradient(180deg,rgba(34,197,94,0.14),rgba(13,18,23,0.96))] text-white shadow-[0_20px_50px_rgba(34,197,94,0.08)] ring-1 ring-brand/20"
                  : "",
                ...
                !cell.inCurrent && !isToday
                  ...
                  : "",
                isSelected && !isToday
                  ? "!border-brand/35 !bg-[linear-gradient(180deg,rgba(34,197,94,0.08),rgba(17,23,34,0.96))] shadow-[0_18px_40px_rgba(34,197,94,0.06)]"
                  : "",
                inSelectedRange(cell.date) && !isToday
                  ? "!border-brand/15 !bg-[linear-gradient(180deg,rgba(34,197,94,0.07),rgba(12,16,23,0.94))]"
                  : "",
