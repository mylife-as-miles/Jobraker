...
export const EmptyState: React.FC<EmptyStateProps> = ({
  ...
  return (
    ...
    >
      ...
      <div className='pointer-events-none absolute -right-10 -top-10 w-40 h-40 bg-[conic-gradient(from_90deg_at_50%_50%,#2fd968_0deg,transparent_140deg)] opacity-10 blur-2xl group-hover:opacity-20 transition-opacity' />
    </div>
  );
};
