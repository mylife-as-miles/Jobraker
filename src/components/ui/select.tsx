...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ...
    className={cn(
      ...
      "transition-all duration-300 hover:border-foreground/30 focus:outline-none focus:ring-2 focus:ring-[#2dd4bf]/40 focus:border-[#2dd4bf]/60",
      "data-[state=open]:border-[#2dd4bf]/60 data-[state=open]:ring-2 data-[state=open]:ring-[#2dd4bf]/30",
      // Disabled
  ...
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      className={cn(
        ...
        // Ring accent when open
        "data-[state=open]:ring-1 data-[state=open]:ring-[#2dd4bf]/25",
        position === "popper" &&
