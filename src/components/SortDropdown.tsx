    ...
    <div className={`relative inline-block text-sm ${className || "w-[180px]"}`} ref={rootRef}>
      <button
        ...
        className={[
          ...
          "border-[#22c55e]/20 shadow-[inset_0_1px_0_rgba(255,255,255,0.03)] backdrop-blur-sm",
          "transition-all duration-200 hover:border-[#22c55e]/35 hover:bg-[#111722]",
          isOpen ? "border-[#22c55e]/40 ring-1 ring-[#22c55e]/20" : "",
        ].join(" ")}
      >
      ...
      {isOpen && (
        <div className="absolute top-full z-50 mt-2 w-full min-w-[180px] overflow-hidden rounded-2xl border border-[#22c55e]/18 bg-[#0d131c]/96 shadow-[0_18px_48px_rgba(0,0,0,0.45)] backdrop-blur-xl">
          <div
            role="listbox"
