...
import {
    Briefcase, GraduationCap, BrainCircuit, FolderGit2, Languages, Heart,
    Trophy, Scroll, BookOpen, HandHeart, Users, LayoutTemplate, Plus
} from 'lucide-react';
...
const STANDARD_SECTIONS = [
    { id: 'experience', label: 'Experience', icon: Briefcase, desc: 'Work history and roles' },
    { id: 'education', label: 'Education', icon: GraduationCap, desc: 'Degrees and schools' },
    { id: 'skills', label: 'Skills', icon: BrainCircuit, desc: 'Technical and soft skills' },
    { id: 'projects', label: 'Projects', icon: FolderGit2, desc: 'Showcase your work' },
    { id: 'languages', label: 'Languages', icon: Languages, desc: 'Languages you speak' },
    { id: 'interests', label: 'Interests', icon: Heart, desc: 'Hobbies and passions' },
    { id: 'awards', label: 'Awards', icon: Trophy, desc: 'Achievements and recognition' },
    { id: 'certifications', label: 'Certifications', icon: Scroll, desc: 'Professional certifications' },
    { id: 'publications', label: 'Publications', icon: BookOpen, desc: 'Articles and papers' },
    { id: 'volunteer', label: 'Volunteering', icon: HandHeart, desc: 'Community service' },
...
export const AddSectionDialog = ({ open, onOpenChange }: AddSectionDialogProps) => {
    ...
    const availableSections = STANDARD_SECTIONS.filter(s => sections[s.id]?.hidden);
                ...
                <div className="border-t border-gray-200 dark:border-white/10 pt-4 mt-2">
                    ...
                    <div className="flex gap-2">
                        <Input
                            ...
                            className="flex-1"
                        />
                        <Button onClick={handleAddCustom} disabled={!customName.trim()} className="bg-[#1dff00] text-black hover:bg-[#15bd00]">
