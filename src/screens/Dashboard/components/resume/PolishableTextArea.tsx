        ...
        <div ref={containerRef} className="relative group">
            <Textarea
                ...
                className={cn(
                    ...
                    isPolishing && "border-[#ffd700] ring-1 ring-[#ffd700] shadow-[0_0_15px_rgba(255,215,0,0.1)]",
                    className
                )}
                {...props}
            />
            ...
            <AnimatePresence>
                ...
                >
                    <button
                        ...
                        className={cn(
                            ...
                            isPolishing
                                ...
                                : "bg-gray-100 dark:bg-muted text-gray-400 hover:text-[#ffd700] hover:bg-[#ffd700]/10"
                        )}
                        title="AI Polish"
                    >
                    ...
                    {isPolishing && (
                        <span className="absolute -inset-1 rounded-lg bg-[#ffd700]/30 animate-ping -z-10" />
                    )}
                </motion.div>
            </AnimatePresence>
