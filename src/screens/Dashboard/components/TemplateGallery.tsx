                ...
                <div className="flex items-center gap-4">
                    <div className="relative hidden sm:block">
                        ...
                        <input
                            ...
                            className="bg-background border border-[#28392b] text-foreground text-sm rounded-lg pl-10 pr-4 py-2 w-64 focus:ring-1 focus:ring-[#ffd700] focus:border-[#ffd700] outline-none placeholder-[#5c6e60]"
                        />
                    </div>
                    <button
                        onClick={onClose}
                            ...
                            {['All', 'Professional', 'Creative', 'Simple', 'Tech'].map((cat) => (
                                <button
                                    ...
                                    className={cn(
                                        ...
                                        filter === cat
                                            ? "bg-[#ffd700]/10 text-[#ffd700] border-[#ffd700]/30 shadow-[0_0_15px_rgba(255,215,0,0.1)]"
                            ...
                            >
                                <div className={cn(
                                    ...
                                    currentTemplate === template.id
                                        ? "border-[#ffd700] border-4 shadow-[0_0_30px_rgba(255,215,0,0.2)]"
                                        : "border-[#28392b] hover:border-[#ffd700]/50"
                                )}>
                                    {/* Preview Content */}
                                    ...
                                    {/* Selected Indicator */}
                                    {currentTemplate === template.id && (
                                        <div className="absolute top-4 right-4 z-20 bg-[#ffd700] text-black rounded-full p-1.5 shadow-lg border-2 border-[#102213]">
                                ...
                                <div className="mt-5 flex justify-between items-start">
                                    <div>
                                        <h3 className={cn(
                                            ...
                                            currentTemplate === template.id ? "text-[#ffd700]" : "text-foreground"
                                        )}>
                                            {template.name}
                                            {currentTemplate === template.id && (
                                                <span className="ml-2 text-[10px] bg-[#ffd700]/20 text-[#ffd700] px-2 py-0.5 rounded border border-[#ffd700]/20 uppercase tracking-wider vertical-middle">Selected</span>
                                            )}
                                        </h3>
                ...
                <div className="max-w-7xl mx-auto flex justify-between items-center">
                    <div className="hidden md:block">
                        <p className="text-foreground font-medium text-base">
                            Selection: <span className="text-[#ffd700]">{activeTemplateInfo?.name || 'None'}</span>
                        </p>
                    ...
                    <div className="flex gap-4 ml-auto">
                        ...
                        <button
                            ...
                            className="px-10 py-3 bg-[#ffd700] hover:bg-[#18d600] text-black rounded-lg font-black text-sm transition-all shadow-[0_0_20px_rgba(255,215,0,0.3)] flex items-center gap-2 active:scale-95"
                        >
