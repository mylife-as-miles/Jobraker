...
export const DesignPanel = () => {
    ...
    const theme = metadata.theme || { primary: '#000000', text: '#000000', background: '#ffffff' };
        ...
        <div className="w-full h-full bg-gray-50 dark:bg-background border-r border-gray-200 dark:border-foreground/10 flex flex-col">
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-8 custom-scrollbar">
                ...
                {activeTab === 'typography' && (
                    <div className="space-y-6 animate-in fade-in duration-300">
                        <div className="space-y-3">
                            <label className="text-xs font-semibold uppercase tracking-wider text-gray-500 dark:text-gray-400">Font Family</label>
                            <Select
                            ...
                            >
                                ...
                                <SelectContent>
                                    <SelectGroup>
                                        ...
                                        {fontFamilies.filter(f => ['IBM Plex Serif', 'Merriweather', 'Playfair Display'].includes(f)).map(font => (
                        ...
                        <div className="space-y-4">
                            <div className="flex items-center justify-between">
                                <label className="text-xs font-semibold uppercase tracking-wider text-gray-500 dark:text-gray-400">Font Size</label>
                                <span className="text-xs font-mono text-gray-400">{typography.size}px</span>
                            </div>
                            <Slider
                                min={8}
                                max={24}
                        ...
                        <div className="space-y-4">
                            <div className="flex items-center justify-between">
                                <label className="text-xs font-semibold uppercase tracking-wider text-gray-500 dark:text-gray-400">Line Height</label>
                                <span className="text-xs font-mono text-gray-400">{typography.lineHeight || 1.5}</span>
                            </div>
                            <Slider
                                min={1}
                                max={2.5}
                                ...
                                onValueChange={(vals) => updateTypography({ lineHeight: vals[0] })}
                            />
                        </div>
                    </div>
                )}
                ...
                {activeTab === 'page' && (
                    <div className="space-y-6 animate-in fade-in duration-300">
                        <div className="space-y-3">
                            <label className="text-xs font-semibold uppercase tracking-wider text-gray-500 dark:text-gray-400">Format</label>
                            <Select
                                value={page.format}
                        ...
                        <div className="space-y-4">
                            <div className="flex items-center justify-between">
                                <label className="text-xs font-semibold uppercase tracking-wider text-gray-500 dark:text-gray-400">Margins</label>
                                <span className="text-xs font-mono text-gray-400">{page.margin}mm</span>
                            </div>
                            <Slider
                                min={0}
                                max={50}
                ...
                {activeTab === 'layout' && (
                    <div className="space-y-6 animate-in fade-in duration-300">
                         <div className="space-y-4">
                            <div className="flex items-center justify-between">
                                <label className="text-xs font-semibold uppercase tracking-wider text-gray-500 dark:text-gray-400">Sidebar Width</label>
                                <span className="text-xs font-mono text-gray-400">{layout.sidebarWidth}%</span>
                            </div>
                            <Slider
                                min={20}
                                max={45}
                                ...
                                onValueChange={(vals) => updateLayout({ sidebarWidth: vals[0] })}
                            />
                            <p className="text-[10px] text-gray-400">
                                Adjusts the width of the sidebar column relative to the page width.
                            </p>
                        </div>
                    </div>
                )}
...
const TabButton = ({ isActive, onClick, icon, label }: { isActive: boolean; onClick: () => void; icon: React.ReactNode; label: string }) => (
    <button
        ...
        className={`
            ...
            ${isActive
                ? 'bg-white dark:bg-muted text-[#2dd4bf] shadow-sm'
