            ...
            <AnimatePresence>
              {showCareerPopup && (
                <motion.div
                  ...
                  className="absolute bottom-20 left-1/2 -translate-x-1/2 z-50 grid grid-cols-2 gap-3 items-center justify-center pointer-events-auto"
                ...
                >
                  ...
                  <button
                    ...
                    className="flex w-36 items-center justify-center gap-2 px-5 py-3 rounded-full bg-card/95 backdrop-blur-xl border border-border/40 hover:bg-brand/15 hover:text-brand hover:border-brand/30 transition-all duration-200 shadow-[0_8px_24px_rgba(0,0,0,0.5),0_0_12px_rgba(29,255,0,0.1)] shrink-0 text-foreground text-sm font-semibold"
                  >
