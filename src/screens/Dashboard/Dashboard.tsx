...
const SidebarItem = ({
  ...
  <Button
    ...
    className={`w-full justify-start rounded-xl mb-1 transition-all duration-200 text-sm font-medium px-4 py-2.5 h-auto group relative overflow-hidden ${isActive
      ? "text-foreground bg-[#2dd4bf]/10 border border-[#2dd4bf]/20"
      : "text-foreground/60 hover:text-foreground/40 hover:bg-foreground/5"
      } ${isCollapsed ? "justify-center px-2" : ""}`}
  >
    {isActive && (
      <div className='absolute left-0 top-0 bottom-0 w-1 bg-[#2dd4bf] shadow-[0_0_10px_#2dd4bf]' />
    )}
    <span
    ...
    <div className='min-h-screen bg-background flex'>
      ...
      >
        ...
        <div className='h-20 flex items-center px-6 border-b border-border/40 relative shrink-0'>
          <div className='absolute inset-x-0 top-0 h-[1px] bg-gradient-to-r from-transparent via-[#2dd4bf]/50 to-transparent opacity-50' />
        ...
        <div className='p-4 border-t border-border/40 bg-card/40 shrink-0'>
          <div
            ...
            className={`group relative overflow-hidden rounded-xl bg-gradient-to-b from-card to-background border border-border/60 cursor-pointer hover:border-[#2dd4bf]/30 transition-all duration-300 ${isCollapsed ? "p-2 flex justify-center" : "p-4"}`}
          >
            <div className='absolute inset-0 bg-[#2dd4bf]/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500' />
            ...
            >
              {!isCollapsed && (
                <div>
                  <h3 className='text-sm font-bold text-foreground group-hover:text-[#2dd4bf] transition-colors'>
                    Pro Plan
                  </h3>
              ...
              <div className='w-8 h-8 rounded-lg bg-[#2dd4bf]/10 flex items-center justify-center text-[#2dd4bf]'>
                <TrendingUp size={16} />
              </div>
            </div>
          ...
          <div className='flex items-center justify-between gap-2'>
            <div className='flex items-center space-x-2 sm:space-x-4 min-w-0 flex-1'>
              ...
              <Button
                variant='ghost'
                size='sm'
                className='hidden lg:flex text-muted-foreground hover:text-[#2dd4bf] hover:bg-[#2dd4bf]/10 transition-all duration-200 p-2 mr-2'
              ...
              <Button
                variant='ghost'
                size='sm'
                className='lg:hidden text-[#2dd4bf] hover:bg-[#2dd4bf]/10 hover:scale-110 transition-all duration-300 p-1 sm:p-2'
            ...
            <div className='flex items-center space-x-1 sm:space-x-2 lg:space-x-4 flex-shrink-0 whitespace-nowrap'>
              ...
              >
                ...
                {unreadCount > 0 && (
                  <span className='absolute -top-1 -right-1 min-w-3 h-3 sm:min-w-4 sm:h-4 lg:min-w-5 lg:h-5 bg-[#2dd4bf] rounded-full text-fore text-[10px] font-bold flex items-center justify-center animate-pulse px-[2px]'>
              ...
              {!profile ? (
                ...
                >
                  <div className='w-6 h-6 sm:w-8 sm:h-8 lg:w-10 lg:h-10 bg-gradient-to-r from-[#22d3ee] to-background rounded-full overflow-hidden flex items-center justify-center hover:scale-110 transition-transform duration-300'>
                    {avatarUrl ? (
              ...
              <Button
                ...
                aria-label='Open profile'
              >
                <div className='w-6 h-6 bg-gradient-to-r from-[#22d3ee] to-background rounded-full overflow-hidden flex items-center justify-center'>
                  {avatarUrl ? (
                    // eslint-disable-next-line @next/next/no-img-element
                    <img
                      src={avatarUrl}
