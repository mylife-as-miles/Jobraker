      ...
      >
        ...
        <div className='flex items-center gap-2 overflow-x-auto pb-1 md:gap-3 md:pb-0 no-scrollbar'>
          ...
          <button
            ...
            className='flex items-center gap-1.5 md:gap-2 px-2.5 md:px-4 py-2 rounded-lg bg-brand hover:bg-brand text-black text-xs md:text-sm font-bold transition-all shadow-[0_0_15px_rgba(47,217,104,0.3)] whitespace-nowrap disabled:opacity-60'
          >
