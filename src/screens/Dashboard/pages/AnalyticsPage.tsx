  ...
  return (
    <div className='relative min-h-screen bg-background'>
      ...
      <div className='relative space-y-6 p-4 sm:p-6 lg:p-8 mx-auto max-w-7xl'>
        ...
        {/* Controls Card */}
        <Card
          className='relative overflow-hidden bg-gradient-to-br from-foreground/10 via-foreground/5 to-foreground/0  border border-[#ffd700]/20 p-5 sm:p-6 rounded-2xl shadow-[0_0_30px_rgba(255,215,0,0.1)] backdrop-blur-xl'
        ...
        >
          ...
          <div className='relative z-10 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4'>
            <div className='flex flex-wrap items-center gap-3'>
              <span className='text-xs uppercase tracking-wider text-[#ffd700]/80 font-semibold'>
                Granularity:
              </span>
              {(["day", "week", "month"] as const).map((g) => (
                <button
                  ...
                  className={`px-3 py-1.5 rounded-lg text-xs font-medium transition-all border-2 ${
                    granularity === g
                      ? "bg-gradient-to-br from-[#ffd700]/20 to-[#b45309]/10 text-[#ffd700] border-[#ffd700]/50 shadow-[0_0_15px_rgba(255,215,0,0.2)]"
              ...
              <span className='ml-3 text-xs uppercase tracking-wider text-[#ffd700]/80 font-semibold'>
                Period:
              </span>
            ...
            <div className='flex items-center gap-3'>
              <Button
                variant='outline'
                className='border-[#ffd700]/30 bg-gradient-to-br from-[#ffd700]/5 to-transparent text-foreground hover:bg-[#ffd700]/10 hover:border-[#ffd700]/50 transition-all duration-200 hover:shadow-[0_0_20px_rgba(255,215,0,0.15)]'
