        ...
        <div className="flex flex-col h-full bg-black text-white p-8 overflow-y-auto">
            ...
            <div className="flex items-center justify-between mb-8">
                <div>
                    ...
                    <p className="text-gray-400 text-sm mt-1">Manage and create your tailored cover letters</p>
                </div>
                    ...
                    {viewMode === 'grid' && (
                        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6">
                            ...
                            >
                                ...
                                <span className="font-medium text-gray-400 group-hover:text-white transition-colors">Create New Letter</span>
                            </motion.div>
                                    ...
                                    <div className="p-4 bg-[#0a0a0a] border-t border-[#ffffff10]">
                                        <div className="flex items-start justify-between">
                                            <div className="min-w-0">
                                                <h3 className="font-semibold text-white truncate pr-2" title={letter.name}>{letter.name || 'Untitled'}</h3>
                        ...
                        <div className="space-y-4">
                            ...
                            >
                                <div className="col-span-6 flex items-center gap-3">
                                    ...
                                    <span className="font-medium text-gray-300 group-hover:text-white">Create New Letter</span>
                                </div>
                            </div>
                            ...
                            {letters.map(letter => (
                                ...
                                >
                                    <div className="col-span-6 flex items-center gap-4">
                                        ...
                                        <div className="min-w-0">
                                            <h3 className="font-semibold text-white truncate">{letter.name || 'Untitled'}</h3>
                                    ...
                                    <div className="col-span-3 flex items-center justify-end gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                                        <button onClick={(e) => { e.stopPropagation(); handleDelete(e, letter.id); }} className="p-2 text-gray-400 hover:text-red-400 hover:bg-red-500/10 rounded-lg" title="Delete">
                                            <Trash2 className="w-4 h-4" />
                                        </button>
                                    </div>
                                </div>
