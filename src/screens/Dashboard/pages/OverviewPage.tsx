  ...
  const mappedNotifs = useMemo(() => {
    return notifItems.map((n) => {
      ...
      if (n.type === "application") {
        className = `${baseSize} ${shared} bg-[#2dd4bf]/15 ring-[#2dd4bf]/40 text-[#b6ffb6] group-hover:ring-[#2dd4bf]/60`;
        ...
        className = `${baseSize} ${shared} bg-background ring-foreground/10 text-foreground group-hover:ring-[#2dd4bf]/50`;
        ...
        <div className='grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8 items-start'>
              ...
              <Card className='bg-card/50 backdrop-blur-xl border border-border/40 p-4 sm:p-6 lg:p-8 rounded-2xl shadow-xl hover:shadow-2xl hover:border-brand/50 hover:shadow-brand/20 transition-all duration-500'>
                <div className='flex flex-col xl:flex-row xl:items-center justify-between mb-6 gap-4'>
                  <div className='flex items-center gap-3'>
                    ...
                    <span className='px-2 py-0.5 rounded-full bg-[#2dd4bf]/10 border border-[#2dd4bf]/20 text-xs font-medium text-[#2dd4bf]'>
                ...
                <div className='mb-3 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 text-[10px] sm:text-xs text-muted-foreground'>
                  ...
                  <div className='flex items-center gap-2'>
                    ...
                    <Button
                      ...
                      className='text-[10px] sm:text-xs px-2 py-1 border border-[#2dd4bf]/20 hover:border-[#2dd4bf]/50 hover:bg-[#2dd4bf]/10 text-[#2dd4bf]'
                    >
                ...
                {selectedRange && (
                  <div className='mt-3 text-center text-[10px] sm:text-xs text-[#888] flex flex-col items-center gap-1'>
                    ...
                    <button
                      ...
                      className='px-2 py-0.5 rounded border border-foreground/10 hover:border-[#2dd4bf]/40 hover:text-[#2dd4bf] hover:bg-[#2dd4bf]/10 text-[10px]'
                    >
                      Clear
                    </button>
                  </div>
          ...
          <div className='space-y-4 sm:space-y-6'>
            ...
            >
              ...
              >
                <div className='absolute -top-24 -right-24 w-72 h-72 rounded-full bg-[#2dd4bf]/5 blur-3xl group-hover:bg-[#2dd4bf]/10 transition' />
                <div className='flex items-center justify-between mb-4 sm:mb-5 relative z-10'>
                  ...
                  <Button
                    ...
                    className='text-foreground/70 hover:text-[#2dd4bf] hover:bg-[#2dd4bf]/10 hover:scale-105 transition-all duration-300 text-xs sm:text-sm font-medium border border-transparent hover:border-[#2dd4bf]/40 px-3'
                  >
                    View all
                  </Button>
                </div>
                ...
                <div className='space-y-2.5 sm:space-y-3 min-h-[140px] relative z-10'>
                  ...
                  {mappedNotifs.length === 0 && !notifLoading && (
                    <div className='flex items-center justify-center p-8 border border-dashed border-[#2dd4bf]/30 rounded-xl bg-foreground/5'>
                      <div className='text-center'>
                        <div className='mx-auto w-12 h-12 rounded-full flex items-center justify-center mb-3'>
                          <Inbox className='w-6 h-6 text-[#2dd4bf]' />
                        </div>
                  ...
                  {!notifLoading &&
                    mappedNotifs.map((notification, index) => (
                      <motion.button
                        ...
                        className='w-full text-left flex items-start gap-3 p-2.5 sm:p-3 rounded-xl border border-foreground/10  bg-gradient-to-br from-foreground/10 via-foreground/5 to-foreground/0 hover:border-[#2dd4bf]/40 transition-all duration-400 group relative overflow-hidden'
                      >
                        {notification.icon}
                        <div className='flex-1 min-w-0'>
                          <p className='text-[11px] sm:text-sm text-foreground font-medium leading-relaxed tracking-tight truncate flex items-center gap-2'>
                            {notification.title}
                            <span className='hidden md:inline-flex text-[9px] px-1.5 py-0.5 rounded bg-foreground/10 border border-[#2dd4bf]/30 text-[#2dd4bf] font-semibold tracking-wide'>
                              NEW
                            </span>
                          </p>
                        ...
                        <span className='absolute inset-0 opacity-0 group-hover:opacity-100 transition bg-gradient-to-r from-transparent via-[#2dd4bf]/5 to-transparent' />
                      </motion.button>
                    ))}
                </div>
              </Card>
