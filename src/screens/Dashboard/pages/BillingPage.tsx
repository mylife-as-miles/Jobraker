    ...
    <div className='min-h-full bg-background selection:bg-brand/30'>
      ...
      <div className='relative overflow-hidden border-b border-foreground/10 bg-gradient-to-br from-background to-background'>
        ...
        <div className='absolute inset-0 overflow-hidden pointer-events-none'>
          ...
          />
          {/* Grid overlay */}
          <div className='absolute inset-0 bg-[linear-gradient(to_right,#16a34a05_1px,transparent_1px),linear-gradient(to_bottom,#16a34a05_1px,transparent_1px)] bg-[size:4rem_4rem] [mask-image:radial-gradient(ellipse_60%_50%_at_50%_0%,#000_70%,transparent_100%)]' />
        </div>
        ...
        <div className='relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16'>
          ...
          >
            <h1 className='text-4xl sm:text-5xl lg:text-7xl font-bold mb-6 tracking-tight'>
              ...
              <span className='text-brand drop-shadow-[0_0_15px_rgba(22,163,74,0.3)]'>
                Credits
              </span>
            </h1>
      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12'>
        {promoApplied && (
          <div className='mb-8'>
            <div className='relative overflow-hidden rounded-2xl border border-brand/20 bg-brand/5 px-6 py-4 backdrop-blur-md flex flex-col sm:flex-row items-center justify-between gap-4 shadow-[0_0_30px_rgba(22,163,74,0.05)]'>
        ...
        <AnimatePresence mode='wait'>
                    ...
                    >
                      ...
                      <Card
                        className={`group relative flex h-full min-h-0 w-full min-w-0 flex-col overflow-hidden transition-all duration-300 ${
                          isCurrentPlan
                            ? "border-brand/50 bg-gradient-to-b from-brand/10 to-transparent shadow-[0_0_40px_-10px_rgba(22,163,74,0.2)]"
                            : isPro &&
                                (billingInterval === "yearly" ||
                                  billingInterval === "quarterly")
                                ...
                                <Button
                                  className={`w-full min-h-12 h-auto py-3 px-3 sm:px-4 font-bold text-xs sm:text-sm tracking-wide transition-all duration-300 ${
                                    isCurrentPlan
                                      ...
                                      : plan.name === "Basics"
                                        ? "bg-brand text-background hover:bg-brand hover:brightness-110 hover:shadow-[0_0_20px_rgba(22,163,74,0.4)] hover:scale-[1.02]"
                                        : plan.name === "Pro"
          ...
          {activeTab === "boosts" && (
            ...
            >
              <section className='relative overflow-hidden rounded-[2rem] border border-brand/20 bg-[radial-gradient(circle_at_top,rgba(22,163,74,0.14),transparent_42%),linear-gradient(180deg,rgba(255,255,255,0.03),rgba(255,255,255,0.01))] p-6 sm:p-8 lg:p-10'>
                <div className='absolute inset-0 bg-[linear-gradient(135deg,rgba(22,163,74,0.05),transparent_36%,rgba(255,255,255,0.04))]' />
                <div className='relative space-y-8'>
                      ...
                      return (
                        <button
                          ...
                          className={`group rounded-[1.6rem] border p-5 text-left transition-all duration-300 ${
                            isSelected
                              ? "border-brand bg-brand/10 shadow-[0_0_28px_rgba(22,163,74,0.18)]"
                  ...
                  {selectedConcurrencyPack ? (
                    <div className='flex flex-col gap-4 rounded-[1.75rem] border border-brand/20 bg-black/35 p-5 sm:flex-row sm:items-center sm:justify-between sm:p-6'>
                      ...
                      <Button
                        className='h-14 min-w-[220px] rounded-full bg-brand px-8 text-base font-bold text-background shadow-[0_0_32px_rgba(22,163,74,0.28)] hover:bg-brand hover:brightness-110'
                        ...
                        <div className='w-full pt-4 border-t border-foreground/5'>
                          ...
                          <Button
                            className={`w-full font-bold transition-all duration-300 ${
                              pack.is_popular
                                ? "bg-brand text-background hover:bg-brand hover:brightness-110 shadow-[0_0_20px_rgba(22,163,74,0.3)]"
