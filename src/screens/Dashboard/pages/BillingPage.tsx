...
export const BillingPage = () => {
  ...
  const getTierIcon = (tier: string) => {
    switch (tier) {
      ...
      default:
        return <Coins className="w-5 h-5 text-[#2dd4bf]" />;
    }
  };
  ...
  const getTierGradient = (tier: string) => {
    switch (tier) {
      ...
      default:
        return 'from-[#22d3ee] via-[#0fc74f] to-[#0a8246]';
    }
  };
  ...
  return (
    <div className="min-h-screen bg-background selection:bg-[#2dd4bf]/30">
      {/* Hero Section */}
      <div className="relative overflow-hidden border-b border-foreground/10 bg-gradient-to-br from-background to-background">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute top-0 left-1/4 w-[500px] h-[500px] bg-[#2dd4bf]/5 rounded-full blur-[120px] mix-blend-screen animate-pulse" />
          ...
          {/* Grid overlay */}
          <div className="absolute inset-0 bg-[linear-gradient(to_right,#2dd4bf05_1px,transparent_1px),linear-gradient(to_bottom,#2dd4bf05_1px,transparent_1px)] bg-[size:4rem_4rem] [mask-image:radial-gradient(ellipse_60%_50%_at_50%_0%,#000_70%,transparent_100%)]" />
        </div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className="grid gap-4 sm:gap-6 md:grid-cols-3">
            ...
            >
              <Card className="relative overflow-hidden border-foreground/10 bg-foreground/[0.03] backdrop-blur-xl group hover:border-[#2dd4bf]/30 transition-colors duration-300">
                <div className="absolute inset-0 bg-gradient-to-br from-[#22d3ee]/5 to-transparent opacity-50" />
                <CardContent className="relative p-6">
                  <div className="flex items-start justify-between mb-4">
                    <div className="p-3 rounded-xl bg-[#2dd4bf]/10 border border-[#2dd4bf]/20 group-hover:bg-[#2dd4bf]/20 transition-colors">
                      <Coins className="w-6 h-6 text-[#2dd4bf]" />
                    </div>
                    <span className="text-[10px] tracking-wider font-bold text-[#2dd4bf] bg-[#2dd4bf]/10 px-2.5 py-1 rounded-full border border-[#2dd4bf]/20">
                      BALANCE
                    </span>
                  </div>
            ...
            {[
              ...
              >
                {activeTab === tab.id && (
                  <motion.div
                    layoutId="activeTab"
                    className="absolute inset-0 bg-[#2dd4bf] rounded-full"
                  ...
                  <button
                    ...
                    className={`relative px-4 sm:px-5 py-2.5 rounded-xl text-sm font-semibold transition-colors inline-flex items-center gap-2 ${
                      billingInterval === 'yearly'
                        ? 'bg-[#2dd4bf] text-background shadow-md'
                        : 'text-muted-foreground hover:text-foreground'
                    }`}
                  >
                    Annual
                  ...
                  return (
                    ...
                    >
                        ...
                        <div className="absolute -top-3 left-0 right-0 flex justify-center z-20">
                          <span className={`text-[10px] font-bold px-3 py-1 rounded-full shadow-lg border ${
                            isUltimate
                              ...
                              : 'bg-[#2dd4bf] text-background border-[#2dd4bf]'
                          }`}>
                            {isUltimate
                              ? billingInterval === 'quarterly'
                                ? 'SCALE · QUARTERLY'
                      ...
                      <Card className={`group relative flex h-full min-h-0 w-full min-w-0 flex-col overflow-hidden transition-all duration-300 ${
                        isCurrentPlan 
                          ? 'border-[#2dd4bf]/50 bg-gradient-to-b from-[#22d3ee]/10 to-transparent shadow-[0_0_40px_-10px_rgba(45,212,191,0.2)]'
                          ...
                          : 'border-foreground/10 bg-foreground/[0.02] hover:bg-foreground/[0.04] hover:border-foreground/20 hover:shadow-xl hover:shadow-[#2dd4bf]/5 hover:-translate-y-1'
                      }`}>
                        ...
                        {isCurrentPlan && (
                          <div className="absolute top-4 right-4 z-10">
                            <span className="px-2.5 py-1 text-[10px] font-bold bg-[#2dd4bf] text-background border border-[#2dd4bf] rounded-full flex items-center gap-1 shadow-md">
                              ...
                              <>
                                ...
                                <div className="mb-5 shrink-0">
                                  <div className={`mb-3 flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-gradient-to-br sm:h-14 sm:w-14 ${
                                    ...
                                    'from-[#22d3ee]/20 to-transparent border-[#2dd4bf]/20'
                                ...
                                <div className="mb-5 shrink-0 space-y-2 border-b border-foreground/10 pb-5">
                                  ...
                                  (billingInterval === 'yearly' || billingInterval === 'quarterly') ? (
                                    <div className="inline-flex items-center gap-1.5 text-xs font-semibold text-[#2dd4bf] bg-[#2dd4bf]/10 border border-[#2dd4bf]/25 rounded-full px-2.5 py-1 mt-1">
                                  ...
                                  <div className="flex min-h-[5rem] items-start gap-3 rounded-xl border border-foreground/5 bg-foreground/5 p-3.5 transition-colors group-hover:bg-foreground/10 sm:min-h-[5.5rem]">
                                    <div className="p-1.5 rounded-lg bg-background/40 shrink-0 mt-0.5">
                                      <Zap className={`w-4 h-4 ${
                                        ...
                                        plan.name === 'Ultimate' ? 'text-purple-400' : 'text-[#2dd4bf]'
                                      }`} />
                                    </div>
                            ...
                            <Button
                              className={`w-full min-h-12 h-auto py-3 px-3 sm:px-4 font-bold text-xs sm:text-sm tracking-wide transition-all duration-300 ${
                                isCurrentPlan
                                  ...
                                  : plan.name === 'Basics'
                                  ? 'bg-[#2dd4bf] text-background hover:bg-[#2dd4bf] hover:brightness-110 hover:shadow-[0_0_20px_rgba(45,212,191,0.4)] hover:scale-[1.02]'
                                  : plan.name === 'Pro'
                  ...
                  >
                    {pack.is_popular && (
                      <div className="absolute -top-3 left-0 right-0 flex justify-center z-10">
                        <span className="bg-[#2dd4bf] text-background text-[10px] font-bold px-3 py-1 rounded-full shadow-lg shadow-[#2dd4bf]/20">
                          BEST VALUE
                        </span>
                      </div>
                    )}
                    ...
                    <Card className={`relative overflow-hidden transition-all duration-300 group hover:scale-105 ${
                      pack.is_popular
                        ? 'border-[#2dd4bf]/30 bg-gradient-to-b from-[#22d3ee]/5 to-transparent'
                        : 'border-foreground/10 bg-foreground/[0.02] hover:bg-foreground/[0.04]'
                    }`}>
                      <CardContent className="p-6 flex flex-col items-center text-center">
                        <div className={`p-3 rounded-2xl mb-4 ${
                          pack.is_popular ? 'bg-[#2dd4bf]/10 text-[#2dd4bf]' : 'bg-foreground/5 text-gray-400 group-hover:text-foreground group-hover:bg-foreground/10'
                        } transition-colors`}>
                        ...
                        <div className="w-full pt-4 border-t border-foreground/5">
                          ...
                          <Button
                            className={`w-full font-bold transition-all duration-300 ${
                              pack.is_popular
                                ? 'bg-[#2dd4bf] text-background hover:bg-[#2dd4bf] hover:brightness-110 shadow-[0_0_20px_rgba(45,212,191,0.3)]'
              ...
              <div className="grid gap-6 sm:grid-cols-3 max-w-4xl mx-auto pt-8 border-t border-foreground/10">
                {[
                  ...
                  <div key={idx} className="flex flex-col items-center text-center p-6 rounded-2xl bg-foreground/[0.02] border border-foreground/5 hover:bg-foreground/[0.04] transition-colors">
                    <div className="p-3 rounded-full bg-[#2dd4bf]/10 text-[#2dd4bf] mb-3">
                      {benefit.icon}
                    </div>
            ...
            >
                      ...
                      {[
                        ...
                        <div key={idx} className="flex items-center justify-between p-4 hover:bg-foreground/[0.02] transition-colors">
                          ...
                          <div className="flex items-center gap-1.5 pl-4 flex-shrink-0">
                            <span className={`text-lg font-bold font-mono ${item.cost === 0 ? 'text-[#2dd4bf]' : 'text-foreground'}`}>
                              {item.cost === 0 ? 'FREE' : item.cost}
                            </span>
                            {item.cost > 0 && <Coins className="w-3.5 h-3.5 text-[#2dd4bf]" />}
                          </div>
                        </div>
                      ))}
                    </div>
              ...
              {(() => {
                ...
                const tierColors: Record<string, { text: string; accent: string; bg: string }> = {
                  ...
                  Basics: { text: 'text-[#2dd4bf]', accent: 'text-[#2dd4bf]', bg: 'bg-[#2dd4bf]/5' },
                        ...
                        <div className="flex flex-wrap items-center gap-2 rounded-full border border-foreground/10 bg-foreground/5 p-1 text-xs">
                          <button
                            ...
                            className={`rounded-full px-3 py-1 font-semibold transition-all ${
                              billingInterval === 'monthly'
                                ? 'bg-[#2dd4bf] text-background shadow-sm'
                                ...
                                return (
                                  <th key={tier} className="text-center px-3 py-4 align-top">
                                    <div className="flex flex-col items-center gap-1.5">
                                      ...
                                      {pricing.savingsBadge && (
                                        <span className="rounded-full bg-[#2dd4bf]/10 border border-[#2dd4bf]/30 px-2 py-0.5 text-[10px] font-bold text-[#2dd4bf]">
                                          {pricing.savingsBadge}
                                        </span>
                                      )}
                                      {isCurrent ? (
                                        ...
                                        <Button
                                          ...
                                          className={`mt-1 h-7 rounded-full px-4 text-[10px] font-bold tracking-wide transition-all ${
                                            tier === 'Basics'
                                              ? 'bg-[#2dd4bf] text-background hover:brightness-110'
                                              : tier === 'Pro'
                              ...
                              <>
                                <tr key={`h-${section.title}`}>
                                  <td
                                    ...
                                    className="px-5 pt-5 pb-2 text-xs font-bold uppercase tracking-widest text-[#2dd4bf]"
                                  >
                                    {section.title}
                                  </td>
                                </tr>
                          ...
                          >
                            ...
                            <div className="text-right flex-shrink-0">
                              <p className={`text-lg font-bold font-mono ${
                                transaction.amount > 0 ? 'text-[#2dd4bf]' : 'text-foreground'
                              }`}>
