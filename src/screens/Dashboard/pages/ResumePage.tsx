...
export const ResumePage = (): JSX.Element => {
  ...
  return (
      <div className="h-full w-full flex flex-col">
        <div id="resume-builder-header" data-tour="resume-builder-header" className="flex items-center justify-between p-3 sm:p-4 border-b border-[#1dff00]/20 bg-[#0a0a0a]/80 backdrop-blur supports-[backdrop-filter]:bg-[#0a0a0a]/60">
          <h1 className="text-lg sm:text-xl font-semibold text-white">Resume Builder</h1>
        </div>
        <div id="resume-canvas" data-tour="resume-canvas" className="flex-1 min-h-[60vh]">
          {loading && (
