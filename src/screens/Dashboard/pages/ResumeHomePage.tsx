        ...
        <div className='grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6'>
          ...
          {resumes.map((resume) => (
            <motion.div
              key={resume.id}
              whileHover={{ y: -5 }}
              className='aspect-[3/4] rounded-xl bg-foreground/40 border overflow-hidden group hover:shadow-xl transition-all relative flex flex-col'
            >
              ...
              {/* Meta Info (Bottom) */}
              <div className='p-4 bg-foreground/5 border-t border-[#ffffff10]'>
