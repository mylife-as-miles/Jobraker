      ...
      <div className='relative max-w-4xl w-full space-y-10'>
        ...
        <div className='grid gap-6 md:grid-cols-2'>
          <button
            ...
            className='group relative overflow-hidden rounded-2xl border border-brand/30 bg-gradient-to-br from-[#141414] via-background to-black p-8 text-left shadow-[0_0_0_1px_rgba(34,197,94,0.15),0_20px_40px_-10px_rgba(0,0,0,0.6)] hover:shadow-[0_0_0_1px_rgba(34,197,94,0.4),0_25px_50px_-12px_rgba(34,197,94,0.15)] transition'
          >
    ...
    >
      ...
      <div className='relative max-w-2xl w-full space-y-10'>
        ...
        <div
          ...
          aria-live='polite'
        >
          <div className='absolute inset-0 bg-[radial-gradient(circle_at_30%_20%,rgba(34,197,94,0.15),transparent_70%)] opacity-70' />
          <div className='relative z-10 flex flex-col gap-8'>
            <div className='flex flex-col lg:flex-row gap-8'>
              <div className='flex-1 flex flex-col gap-4'>
                ...
                >
                  <div
                    className={`flex flex-col items-center justify-center gap-4 border-2 border-dashed rounded-xl py-12 px-6 relative overflow-hidden transition ${dragActive ? "border-brand bg-brand/10 shadow-[0_0_0_1px_rgba(34,197,94,0.4),0_0_20px_-2px_rgba(34,197,94,0.4)]" : "border-brand/40 group-hover:border-brand bg-brand/5"}`}
                  >
                    <div className='absolute inset-0 opacity-0 group-hover:opacity-100 bg-gradient-to-tr from-brand/10 to-transparent transition' />
          ...
          <div className='space-y-6'>
            ...
            <div className='pt-2 flex justify-center'>
              <Button
                ...
                disabled={uploading}
                className='w-full max-w-md bg-brand text-black hover:bg-brand/90 transition-all h-11 text-sm font-semibold rounded-lg shadow-[0_0_15px_rgba(34,197,94,0.2)]'
              >
          ...
          return (
            <button
              ...
              className={`text-left relative flex flex-col p-5 rounded-2xl border transition-all duration-300 ${
                isSelected
                  ? "border-brand bg-brand/5 shadow-[0_0_20px_rgba(34,197,94,0.1)]"
