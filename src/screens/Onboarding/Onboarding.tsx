...
export const Onboarding = (): JSX.Element => {
  ...
  return (
    <div className="bg-black flex flex-col justify-center items-center w-full min-h-screen relative overflow-hidden px-3 sm:px-4 md:px-5 lg:px-6 xl:px-8">
      ...
      {/* Onboarding Card - Dynamically scaled based on screen size */}
      <motion.div
        className="w-full"
        style={{
          maxWidth: `${getScaledValue(400)}px`,
      ...
      >
        ...
        >
          ...
          <CardContent 
            ...
            style={{ padding: `${getScaledValue(24)}px` }}
          >
            {/* Progress indicator - Dynamically scaled */}
            <motion.div
            ...
            {/* Navigation buttons - Dynamically scaled */}
            <motion.div
              ...
              >
                <Button
                  ...
                  className={`flex items-center transition-all duration-300 ${
                    currentStep === 0
                      ? "text-[#ffffff33] cursor-not-allowed"
                      : "text-white hover:bg-[#ffffff26] border border-[#ffffff15]"
                  }`}
                  style={{
