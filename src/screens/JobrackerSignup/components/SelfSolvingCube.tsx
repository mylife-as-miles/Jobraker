    ...
    <mesh position={position} ref={ref}>
      ...
      <group scale={[0.96, 0.96, 0.96]}>
        <RoundedBox args={[CUBE_SIZE, CUBE_SIZE, CUBE_SIZE]} radius={0.05} smoothness={4}>
          ...
          <Edges threshold={15} color="#ffd700" renderOrder={100} scale={1.0} linewidth={1} />
        </RoundedBox>
      </group>
...
export const SelfSolvingCube = () => {
  return (
    <div className="w-full h-full relative group">
      ...
      <div className="absolute inset-0 bg-[#ffd700] blur-[150px] opacity-[0.03] animate-pulse pointer-events-none" />
      ...
      >
        ...
        <pointLight position={[10, 10, 10]} intensity={2} color="#ffd700" distance={20} />
