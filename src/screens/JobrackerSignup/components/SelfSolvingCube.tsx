...
const CubeFallback = () => (
  <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
    <div className="relative w-[200px] h-[200px]">
      <div className="absolute inset-0 border border-[#22c55e]/20 rounded-md rotate-12 animate-pulse" />
      <div className="absolute inset-6 border border-[#22c55e]/15 rounded-md -rotate-6" />
      <div className="absolute inset-12 border border-[#22c55e]/10 rounded-md rotate-3" />
