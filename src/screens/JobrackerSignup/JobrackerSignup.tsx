                  ...
                  <AnimatePresence mode="wait">
                    ...
                    >
                      ...
                      >
                        ...
                        <div className="flex w-full items-center relative bg-transparent border border-solid border-[#ffffff33] shadow-[0px_2px_14px_#0000000d] backdrop-blur-sm hover:border-[#ffffff4d] focus-within:border-none transition-all duration-300 h-12 sm:h-14 md:h-16 lg:h-18 px-4 sm:px-5 md:px-6 rounded-lg sm:rounded-xl">
