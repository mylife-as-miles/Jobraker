...
const logs = [
  ...
  { type: 'action', text: 'Scanning for high-fit software roles...', icon: <Search className="w-3 h-3 text-[#1dff00]" /> },
  ...
  { type: 'action', text: 'Tailoring resume language for this role...', icon: <FileText className="w-3 h-3 text-[#1dff00]" /> },
  { type: 'success', text: 'Resume draft ready for review.' },
  { type: 'action', text: 'Preparing governed application package...', icon: <Send className="w-3 h-3 text-[#1dff00]" /> },
      ...
      <div className="rounded-lg overflow-hidden border border-[#1dff00]/30 bg-background/80 backdrop-blur-xl shadow-[0_0_30px_rgba(29,255,0,0.15)]">
        ...
        <div className="flex items-center justify-between px-4 py-2 bg-[#1dff00]/10 border-b border-[#1dff00]/20">
          <div className="flex items-center space-x-2">
            <div className="w-3 h-3 rounded-full bg-[#1dff00]/80"></div>
            <div className="w-3 h-3 rounded-full bg-[#1dff00]/80"></div>
            <div className="w-3 h-3 rounded-full bg-[#1dff00]/80"></div>
          </div>
