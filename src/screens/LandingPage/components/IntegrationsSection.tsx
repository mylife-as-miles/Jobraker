      ...
      <div className='relative w-full h-[600px] flex items-center justify-center overflow-visible'>
        ...
        <div className='absolute z-20'>
          <div className='relative flex items-center justify-center'>
            ...
            />
            <div className='w-20 h-20 bg-background rounded-full border border-brand/50 flex items-center justify-center shadow-[0_0_30px_rgba(34,197,94,0.3)] relative z-20 backdrop-blur-sm'>
