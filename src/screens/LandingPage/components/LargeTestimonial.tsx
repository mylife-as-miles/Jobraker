...
export const LargeTestimonial = () => {
  return (
    <section className="py-24 bg-background border-y border-[#2dd4bf]/10">
      <div className="container mx-auto px-4 max-w-5xl text-center">
        <Quote className="w-12 h-12 text-[#2dd4bf] mx-auto mb-8 opacity-50" />
        ...
        <div className="flex flex-col items-center">
          <div className="w-16 h-16 bg-gradient-to-br from-[#22d3ee] to-background rounded-full mb-4" />
          <div className="text-foreground font-bold font-mono text-lg">Alex V.</div>
          <div className="text-[#2dd4bf] font-mono text-sm">Senior Frontend Engineer @ TechGiant</div>
        </div>
      </div>
    </section>
  );
