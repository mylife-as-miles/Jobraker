  ...
  return (
    <div className="w-full max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 relative z-20 py-12 md:py-24">
      ...
      >
        ...
        <div className="absolute inset-0 bg-[#ffd700] blur-[100px] opacity-10 rounded-full transform scale-75 z-0" />

        {/* Dashboard Container */}
        <div className="relative bg-background rounded-xl border border-[#ffd700]/20 shadow-[0_0_50px_rgba(255,215,0,0.15)] overflow-hidden backdrop-blur-sm z-10">
          ...
          <div className="p-1">
             <div className="grid grid-cols-1 md:grid-cols-3 gap-1">
                {/* Sidebar Mock */}
                <div className="hidden md:block col-span-1 bg-background/20 border-r border-[#ffd700]/10 p-4 space-y-4">
                   <div className="h-8 w-24 bg-[#ffd700]/10 rounded mb-6" />
                   <div className="h-4 w-full bg-muted/50 rounded" />
                   <div className="h-4 w-3/4 bg-muted/50 rounded" />
                   <div className="h-4 w-5/6 bg-muted/50 rounded" />
                   <div className="mt-8 h-32 w-full border border-[#ffd700]/20 rounded bg-background/40 relative overflow-hidden">
                      <div className="absolute inset-0 bg-gradient-to-t from-[#fbbf24]/10 to-transparent" />
                   </div>
                </div>
