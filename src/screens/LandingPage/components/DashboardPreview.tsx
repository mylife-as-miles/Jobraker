  ...
  return (
    <div className="w-full max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 relative z-20 py-12 md:py-24">
      ...
      >
        ...
        {/* Dashboard Container */}
        <div className="relative bg-background rounded-xl border border-[#1dff00]/20 shadow-[0_0_50px_rgba(29,255,0,0.15)] overflow-hidden backdrop-blur-sm z-10">

          {/* Mock Browser Bar */}
          <div className="h-10 bg-background/50 border-b border-[#1dff00]/10 flex items-center px-4 space-x-2">
            <div className="w-3 h-3 rounded-full bg-[#1dff00]/20 border border-[#1dff00]/50" />
            <div className="w-3 h-3 rounded-full bg-[#1dff00]/20 border border-[#1dff00]/50" />
            <div className="w-3 h-3 rounded-full bg-[#1dff00]/20 border border-[#1dff00]/50" />
            <div className="ml-4 flex-1 bg-background/30 h-6 rounded border border-[#1dff00]/10 flex items-center px-3 text-[10px] text-gray-600 font-mono">
          ...
          <div className="p-1">
             <div className="grid grid-cols-1 md:grid-cols-3 gap-1">
                {/* Sidebar Mock */}
                <div className="hidden md:block col-span-1 bg-background/20 border-r border-[#1dff00]/10 p-4 space-y-4">
                   <div className="h-8 w-24 bg-[#1dff00]/10 rounded mb-6" />
                   <div className="h-4 w-full bg-muted/50 rounded" />
                   <div className="h-4 w-3/4 bg-muted/50 rounded" />
                   <div className="h-4 w-5/6 bg-muted/50 rounded" />
                   <div className="mt-8 h-32 w-full border border-[#1dff00]/20 rounded bg-background/40 relative overflow-hidden">
                ...
                <div className="col-span-2 p-4 md:p-8 bg-background/40 min-h-[400px] flex flex-col items-center justify-center">
                   <div className="mb-6 text-center">
                      <h3 className="text-[#1dff00] font-mono text-xl mb-2">AGENT WORKFLOW LIVE</h3>
