...
const Globe = () => {
  ...
  return (
    <group rotation={[0, 0, Math.PI / 6]}>
      ...
      {/* 6. Orbit Rings */}
      <OrbitRing radius={2.5} speed={0.3} color="#ffd700" opacity={0.4} />
      <OrbitRing radius={3.0} speed={0.2} color="#ffd700" opacity={0.2} rotateX={Math.PI / 2.5} />
      <OrbitRing radius={2.8} speed={-0.2} color="#ffffff" opacity={0.15} rotateZ={Math.PI / 4} />
      <OrbitRing radius={3.5} speed={0.1} color="#ffd700" opacity={0.1} rotateY={Math.PI / 3} />
    </group>
  );
};
