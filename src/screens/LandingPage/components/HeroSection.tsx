...
export const HeroSection = () => {
  ...
  return (
    <div className='relative w-full min-h-screen flex flex-col justify-center overflow-hidden bg-background pt-24 pb-20 px-4 sm:px-6 lg:px-8'>
      ...
      <div className='absolute inset-0 bg-[linear-gradient(to_right,#22c55e0a_1px,transparent_1px),linear-gradient(to_bottom,#22c55e0a_1px,transparent_1px)] bg-[size:4rem_4rem] [mask-image:radial-gradient(ellipse_60%_50%_at_50%_0%,#000_70%,transparent_100%)] pointer-events-none' />
        ...
        <div className='flex-1 text-center lg:text-left space-y-8 z-20 pt-10 lg:pt-0'>
          ...
          <div className='flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 pt-4'>
            <Button
              ...
              className='bg-brand text-black hover:bg-brand/90 h-12 px-6 text-base font-bold rounded-none border border-brand transition-all hover:shadow-[0_0_20px_rgba(34,197,94,0.4)] w-full sm:w-auto'
            >
              Sign Up
