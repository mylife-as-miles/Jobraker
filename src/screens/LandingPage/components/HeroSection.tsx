...
export const HeroSection = () => {
  ...
  return (
    <div className="relative w-full min-h-screen flex flex-col justify-center overflow-hidden bg-background pt-24 pb-20 px-4 sm:px-6 lg:px-8">
      ...
      <div className="absolute inset-0 bg-[linear-gradient(to_right,#2dd4bf0a_1px,transparent_1px),linear-gradient(to_bottom,#2dd4bf0a_1px,transparent_1px)] bg-[size:4rem_4rem] [mask-image:radial-gradient(ellipse_60%_50%_at_50%_0%,#000_70%,transparent_100%)] pointer-events-none" />
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-20">
        ...
        <div className="flex-1 text-center lg:text-left space-y-8 z-20 pt-10 lg:pt-0">
          <div className="inline-flex items-center space-x-2 px-3 py-1 rounded-full border border-[#2dd4bf]/30 bg-[#2dd4bf]/5 text-[#2dd4bf] text-xs font-mono tracking-widest uppercase animate-fade-in-up">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold font-mono tracking-tight text-foreground leading-[0.9] lg:leading-[0.9]">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#22d3ee] via-[#80ff72] to-background">
              Never Sleeps
            </span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 pt-4">
            <Button
              ...
              className="bg-[#2dd4bf] text-black hover:bg-[#2dd4bf]/90 h-12 px-6 text-base font-bold rounded-none border border-[#2dd4bf] transition-all hover:shadow-[0_0_20px_rgba(45,212,191,0.4)] w-full sm:w-auto"
            >
              DEPLOY AGENT
            ...
            <Button
              variant="outline"
              className="border-[#2dd4bf] text-[#2dd4bf] bg-transparent hover:bg-[#2dd4bf]/10 h-12 px-6 text-base font-mono rounded-none w-full sm:w-auto"
            >
          ...
          <div className="pt-8 flex items-center justify-center lg:justify-start space-x-8 text-neutral-500 text-sm font-mono">
             <div className="flex items-center space-x-2">
                <span className="text-[#2dd4bf] font-bold">50k+</span>
                <span>Job Boards</span>
             </div>
             <div className="w-px h-4 bg-neutral-800" />
             <div className="flex items-center space-x-2">
                <span className="text-[#2dd4bf] font-bold">24/7</span>
                <span>Active</span>
             </div>
          </div>
        </div>
        ...
        <div className="flex-1 w-full relative h-[400px] sm:h-[500px] lg:h-[600px] flex items-center justify-center perspective-1000 -mt-10 lg:mt-0">
             ...
             <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[350px] h-[350px] bg-[#2dd4bf] rounded-full blur-[150px] opacity-15 pointer-events-none" />
             <EarthOrb />
        </div>
