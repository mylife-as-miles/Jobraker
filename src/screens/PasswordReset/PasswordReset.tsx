    ...
    <div className="min-h-screen bg-background flex items-center justify-center px-4">
      <div className="w-full max-w-sm sm:max-w-md lg:max-w-lg">
        <div className="relative">
          <div className="absolute inset-0 bg-gradient-to-r from-[#22d3ee]/20 via-transparent to-[#0d9488]/20 opacity-50 rounded-xl sm:rounded-2xl" />
                ...
                <form onSubmit={handleUpdate} className="space-y-4">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="space-y-2 text-xs sm:text-sm">
                      <div className="flex items-center justify-between">
                        ...
                        <span className={`font-semibold ${check.score >= 4 ? 'text-[#2dd4bf]' : check.score >= 3 ? 'text-yellow-300' : 'text-red-400'}`}>{check.strength}</span>
                      </div>
                  ...
                  <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                    <Button
                      ...
                      className="w-full shadow-[0px_3px_14px_#00000040] bg-[linear-gradient(270deg,rgba(45,212,191,1)_0%,rgba(10,130,70,1)_85%)] text-foreground font-bold rounded-xl disabled:opacity-60"
                    >
                      Update Password
                    </Button>
                  </motion.div>
