...
export const ACTION_RECIPES: Record<string, ActionRecipe> = {
  recruiter_cold_outreach: {
    ...
    tagline: "Scout verified recruiters, craft tailored pitches, and create Gmail drafts in 3 single clicks.",
    description: "Automate direct recruiter outreach without burning tokens or guessing prompts. Select target jobs, pull decision-maker emails, review AI-crafted hooks, and push directly to your Gmail drafts.",
    category: "outreach",
    badge: "1-Click",
    ...
    stages: [
      {
        ...
        description: "Scout verified talent partners, hiring managers, and department leads with 4-tier verification.",
      },
      {
        id: "craft_messages",
        stepNumber: 2,
      ...
      },
      {
        ...
        description: "Sync drafts safely into your Gmail workspace or send with anti-spam jitter delivery.",
      },
    ],
  },
  instant_job_pitch: {
