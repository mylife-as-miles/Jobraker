      ...
      <div className='flex items-center justify-between gap-3'>
        ...
        <div className='flex gap-2'>
          ...
          <button
            {...primaryProps}
            disabled={waiting}
            className='px-3 py-1.5 rounded-md text-xs font-semibold bg-brand text-black hover:brightness-110 shadow-[0_0_0_1px_rgba(47,217,104,0.4)] transition-all'
          >
...
export const JoyrideAdapter: React.FC = () => {
  ...
  .react-joyride__overlay { backdrop-filter: blur(0.4px); }
    .react-joyride__spotlight { box-shadow: 0 0 0 2px #2fd968, 0 0 0 6px rgba(47,217,104,0.25), 0 0 0 10000px rgba(0,0,0,0.45) !important; border-radius: 12px !important; }
        ...
        .react-joyride__beacon { box-shadow: 0 0 0 0 rgba(47,217,104,0.65); animation: joyPulse 2.4s ease-in-out infinite; }
        @keyframes joyPulse { 0%{ box-shadow:0 0 0 0 rgba(47,217,104,0.45);} 70%{ box-shadow:0 0 0 14px rgba(47,217,104,0);} 100%{ box-shadow:0 0 0 0 rgba(47,217,104,0);} }
      `;
  ...
  return (
    <Joyride
      ...
      styles={{
        ...
        buttonNext: { background: "#2fd968", color: "#000", fontWeight: 600 },
        buttonBack: { color: "#2fd968" },
        buttonSkip: { color: "#2fd968" },
        beaconInner: { backgroundColor: "#2fd968" },
      }}
