...
export const FloatingTourMenu: React.FC<{
  ...
  return (
    <div className='fixed z-[12000] xl:bottom-4 bottom-10 right-4 flex flex-col items-end gap-2'>
      ...
      <button
        onClick={() => setOpen((o) => !o)}
        className={`h-11 px-4 rounded-full font-semibold text-sm flex items-center gap-2 shadow-[0_0_0_1px_rgba(34,197,94,0.3),0_8px_18px_-6px_rgba(0,0,0,0.6)] transition-colors ${open ? "bg-brand text-black" : "bg-background text-brand hover:bg-[#132413]"}`}
        aria-expanded={open}
