            ...
            <div className="p-6 space-y-6">
              ...
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-1 gap-2">
                  ...
                  <ActionButton icon={<Crown className="w-4 h-4" />} label="Change Subscription" onClick={onChangePlan} color="yellow" />
                  <ActionButton icon={<Trash2 className="w-4 h-4" />} label="Delete User" onClick={onDelete} color="red" />
                </div>
              </div>
      ...
      >
        ...
        >
          ...
          <div className="px-6 pt-6 pb-4 border-b border-yellow-500/20">
            ...
            <p className="text-sm text-gray-400">
              Current plan: <span className="text-yellow-400 font-semibold">{user.subscription_tier}</span>
            </p>
          </div>
          ...
          <div className="px-6 pb-6 flex gap-3">
            ...
            <motion.button
              ...
              className="flex-1 px-4 py-3 bg-gradient-to-r from-yellow-500 to-yellow-600 text-black font-semibold rounded-xl hover:shadow-lg hover:shadow-yellow-500/20 transition-all disabled:opacity-50 flex items-center justify-center gap-2"
            >
        ...
        >
          ...
          <div className="p-6 space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 bg-gray-800 border border-red-500/30 rounded-xl text-white placeholder-gray-500 focus:border-red-500 focus:outline-none transition-colors"
              />
            </div>
          </div>
          ...
          <div className="px-6 pb-6 flex gap-3">
            ...
            <motion.button
              ...
              className="flex-1 px-4 py-3 bg-gradient-to-r from-red-500 to-red-600 text-white font-semibold rounded-xl hover:shadow-lg hover:shadow-red-500/20 transition-all disabled:opacity-30 flex items-center justify-center gap-2"
            >
