          ...
          >
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2 mt-1">
                    ...
                    <span className={`inline-flex items-center gap-1 px-2 py-0.5 rounded-md border text-xs font-medium ${getTierBadgeClass(user.subscription_tier)}`}>
              ...
              <div className="grid grid-cols-2 gap-3">
                <StatMini icon={<Coins className="w-4 h-4 text-[#1dff00]" />} label="Credits" value={user.credits_balance} />
                <StatMini icon={<Zap className="w-4 h-4 text-[#1dff00]" />} label="Used" value={user.credits_consumed} />
              ...
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-1 gap-2">
                  <ActionButton icon={<Plus className="w-4 h-4" />} label="Top Up Credits" onClick={onTopUp} color="green" />
                  <ActionButton icon={<Crown className="w-4 h-4" />} label="Change Subscription" onClick={onChangePlan} color="accent" />
                  <ActionButton icon={<Trash2 className="w-4 h-4" />} label="Delete User" onClick={onDelete} color="danger" />
                </div>
              </div>
                    ...
                    {transactions.map((tx) => (
                      ...
                      >
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <p className="text-sm text-white font-medium">{tx.description || tx.transaction_type || tx.type}</p>
...
function StatMini({ icon, label, value }: { icon: React.ReactNode; label: string; value: number }) {
  return (
    <div className="bg-gray-800/50 border border-gray-700/50 rounded-xl p-3 flex items-center gap-3">
      <div className="w-9 h-9 rounded-lg bg-gray-700/50 flex items-center justify-center">{icon}</div>
      <div>
...
function ActionButton({ icon, label, onClick, color }: { icon: React.ReactNode; label: string; onClick: () => void; color: 'green' | 'accent' | 'danger' }) {
  const colorClasses = {
    green: 'border-[#1dff00]/30 hover:border-[#1dff00] hover:bg-[#1dff00]/10 text-[#1dff00]',
    accent: 'border-[#1dff00]/30 hover:border-[#1dff00] hover:bg-[#1dff00]/10 text-[#1dff00]',
    danger: 'border-[#1dff00]/30 hover:border-[#1dff00] hover:bg-[#1dff00]/10 text-[#1dff00]',
  };
  return (
    <motion.button
        ...
        >
          ...
          <div className="px-6 pt-6 pb-4 border-b border-[#1dff00]/20">
            <div className="flex items-center gap-3 mb-2">
              <div className="w-10 h-10 rounded-xl bg-[#1dff00]/20 flex items-center justify-center">
            ...
            <p className="text-sm text-gray-400">
              Current balance: <span className="text-[#1dff00] font-semibold">{user.credits_balance}</span> credits
            </p>
          </div>
          ...
          <div className="p-6 space-y-4">
            ...
            <div>
              ...
              <input
                ...
                min={1}
                className="w-full px-4 py-3 bg-gray-800 border border-gray-700 rounded-xl text-white placeholder-gray-500 focus:border-[#1dff00] focus:outline-none transition-colors text-lg font-bold"
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 bg-gray-800 border border-gray-700 rounded-xl text-white placeholder-gray-500 focus:border-[#1dff00] focus:outline-none transition-colors"
              />
            </div>

            {/* Preview */}
            <div className="bg-[#1dff00]/5 border border-[#1dff00]/20 rounded-xl p-4">
              ...
              <div className="flex justify-between text-sm mt-1">
                ...
                <span className="text-[#1dff00] font-semibold">+{amount}</span>
              </div>
              <div className="border-t border-[#1dff00]/20 my-2" />
              <div className="flex justify-between text-sm font-bold">
                <span className="text-white">New Balance</span>
                <span className="text-[#1dff00]">{user.credits_balance + amount}</span>
              </div>
            </div>
          </div>
...
function ChangePlanDialog({
  ...
  const planIcons: Record<string, React.ReactNode> = {
    ...
    'Basics': <Star className="w-5 h-5 text-[#1dff00]" />,
        ...
        >
          ...
          <div className="px-6 pt-6 pb-4 border-b border-[#1dff00]/20">
            <div className="flex items-center gap-3 mb-2">
              ...
              <div>
                <h3 className="text-lg font-bold text-white">Change Subscription</h3>
                <p className="text-sm text-gray-400">{user.email}</p>
              </div>
            </div>
            <p className="text-sm text-gray-400">
              Current plan: <span className="text-[#1dff00] font-semibold">{user.subscription_tier}</span>
            </p>
          </div>
          ...
          <div className="px-6 pb-6 flex gap-3">
            ...
            <motion.button
              ...
              className="flex-1 px-4 py-3 bg-gradient-to-r from-[#1dff00] to-[#1dff00] text-black font-semibold rounded-xl hover:shadow-lg hover:shadow-[#1dff00]/20 transition-all disabled:opacity-50 flex items-center justify-center gap-2"
            >
    ...
    <AnimatePresence>
      ...
      >
        ...
        >
          ...
          <div className="px-6 pt-6 pb-4 border-b border-[#1dff00]/20">
            <div className="flex items-center gap-3 mb-3">
              <div className="w-12 h-12 rounded-xl bg-[#1dff00]/20 flex items-center justify-center">
                <AlertTriangle className="w-6 h-6 text-[#1dff00]" />
              </div>
              <div>
                <h3 className="text-lg font-bold text-white">Delete User</h3>
                <p className="text-sm text-[#1dff00]">This action cannot be undone</p>
              </div>
            </div>
          </div>
          ...
          {/* Body */}
          <div className="p-6 space-y-4">
            <div className="bg-[#1dff00]/10 border border-[#1dff00]/20 rounded-xl p-4">
              <p className="text-sm text-gray-300 mb-2">
                You are about to permanently delete the user <strong className="text-white">{user.email}</strong> and all their data:
              </p>
            ...
            <div>
              <label className="text-sm text-gray-400 block mb-2">
                Type <span className="text-[#1dff00] font-mono">{user.email}</span> to confirm
              </label>
              <input
                type="text"
                value={confirmEmail}
                ...
                className="w-full px-4 py-3 bg-gray-800 border border-[#1dff00]/30 rounded-xl text-white placeholder-gray-500 focus:border-[#1dff00] focus:outline-none transition-colors"
              />
            </div>
          </div>
          ...
          <div className="px-6 pb-6 flex gap-3">
            ...
            <motion.button
              ...
              className="flex-1 px-4 py-3 bg-gradient-to-r from-[#1dff00] to-[#1dff00] text-white font-semibold rounded-xl hover:shadow-lg hover:shadow-[#1dff00]/20 transition-all disabled:opacity-30 flex items-center justify-center gap-2"
            >
          ...
          <>
            ...
            >
              ...
              <button onClick={() => { setOpen(false); onChangePlan(); }} className="w-full flex items-center gap-3 px-4 py-3 text-sm text-gray-300 hover:text-white hover:bg-foreground/5 transition-all">
                <Crown className="w-4 h-4 text-[#1dff00]" /> Change Plan
              </button>
              ...
              <button onClick={() => { setOpen(false); onDelete(); }} className="w-full flex items-center gap-3 px-4 py-3 text-sm text-[#1dff00] hover:text-[#1dff00] hover:bg-[#1dff00]/10 transition-all">
...
function getTierIcon(tier: string) {
  switch (tier) {
    ...
    case 'Basics': return <Star className="w-4 h-4 text-[#1dff00]" />;
...
function getTierBadgeClass(tier: string) {
  switch (tier) {
    ...
    case 'Basics': return 'bg-[#1dff00]/20 text-[#1dff00] border-[#1dff00]/30';
...
function getStatusBadgeClass(status: string) {
  switch (status) {
    ...
    case 'inactive': return 'bg-[#1dff00]/20 text-[#1dff00] border-[#1dff00]/30';
    default: return 'bg-[#1dff00]/20 text-[#1dff00] border-[#1dff00]/30';
  }
}
...
export default function AdminUsers() {
  ...
  // CSV export
  const exportCSV = () => {
    const headers = ['Email', 'Name', 'Tier', 'Status', 'Credits', 'Used', 'Searches', 'Auto Applies', 'Last Updated'];
    const rows = filteredActivities.map(u => [
      u.email, u.full_name || '', u.subscription_tier, u.status,
      u.credits_balance, u.credits_consumed, u.job_searches, u.auto_applies,
  ...
  if (error) {
    return (
      <div className="bg-[#1dff00]/20 border border-[#1dff00] rounded-xl p-6">
        <p className="text-[#1dff00]">Error loading users: {error}</p>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6">
      ...
      <UserDetailPanel
        ...
        onTopUp={() => { setShowDetail(false); setTimeout(() => openTopUp(selectedUser), 200); }}
        onChangePlan={() => { setShowDetail(false); setTimeout(() => openChangePlan(selectedUser), 200); }}
        onDelete={() => { setShowDetail(false); setTimeout(() => openDelete(selectedUser), 200); }}
