        ...
        >
          ...
          <div className="p-6 space-y-8">
            {loading ? (
              ...
              <div className="p-4 bg-[#1dff00]/10 border border-[#1dff00]/20 rounded-xl text-[#1dff00] flex items-center gap-3">
              ...
              {loading ? (
                ...
                filteredTables.map((table, index) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4">
                      {table.error ? (
                        <div className="flex items-center gap-1.5 text-[#1dff00] text-xs">
