    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="w-full max-w-xl h-full bg-background border-l border-[#ffd700]/20 shadow-2xl overflow-y-auto"
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 gap-2">
                    {schemaKeys.length === 0 ? (
                      ...
                      schemaKeys.map(key => (
                        <div key={key} className="flex items-center justify-between p-3 bg-gray-900/50 rounded-lg border border-gray-800 hover:border-[#ffd700]/30 transition-colors">
        ...
        >
          ...
          <div className="relative z-10">
            <div className="flex items-center justify-between mb-4">
              ...
              <span className="text-xs font-medium text-[#ffd700] bg-[#ffd700]/10 px-2 py-1 rounded-full">Core Tables</span>
            </div>
