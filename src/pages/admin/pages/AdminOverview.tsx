...
export default function AdminOverview() {
  ...
  if (error) {
    return (
      <Card className="bg-gradient-to-br from-[#1dff00]/20 to-[#1dff00]/20 border-[#1dff00]/50">
        <CardContent className="p-6">
          <p className="text-[#1dff00]">Error loading stats: {error}</p>
        </CardContent>
      </Card>
    );
  }
                ...
                <CardContent className="p-6">
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="flex items-center gap-1">
                      <TrendIcon className={`w-4 h-4 ${stat.trend === 'up' ? 'text-[#1dff00]' : 'text-[#1dff00]'}`} />
                      <span className={`text-sm font-medium ${stat.trend === 'up' ? 'text-[#1dff00]' : 'text-[#1dff00]'}`}>
                        {stat.change}
                      </span>
