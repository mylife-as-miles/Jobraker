...
export default function AdminOverview() {
  ...
  const featureUsage = [
    { feature: "Job Search", value: stats.totalJobSearches, fill: "#2fd968" },
    { feature: "Auto Apply", value: stats.totalAutoApplies, fill: "#2fd968" },
  ];
                ...
                <div className='space-y-6'>
                  ...
                  <ResponsiveContainer width='100%' height={280}>
                    <BarChart data={feedbackDistribution}>
                      ...
                      />
                      <Bar dataKey='count' radius={[8, 8, 0, 0]} fill='#2fd968' />
                    </BarChart>
                  </ResponsiveContainer>
                </div>
              )}
                  ...
                  <AreaChart data={feedbackTrend}>
                    <defs>
                      <linearGradient
                        ...
                        y2='1'
                      >
                        <stop offset='5%' stopColor='#2fd968' stopOpacity={0.28} />
                        <stop offset='95%' stopColor='#2fd968' stopOpacity={0} />
                      </linearGradient>
                    </defs>
                    <CartesianGrid strokeDasharray='3 3' stroke='#374151' />
                    <XAxis
