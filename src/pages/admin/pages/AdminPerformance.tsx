        ...
        >
          ...
          <div className="p-6 space-y-8">
            ...
            <div className={`flex flex-col items-center justify-center p-8 rounded-2xl border ${service.status === 'healthy'
              ...
              <h3 className={`text-2xl font-bold capitalize ${service.status === 'healthy' ? 'text-[#1dff00]' : 'text-red-500'}`}>
                {service.status}
              </h3>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        >
          <div className="flex items-center gap-4">
            <div className={`w-12 h-12 rounded-xl flex items-center justify-center ${systemStatus === 'Healthy' ? 'bg-[#1dff00]/20 text-[#1dff00]' : 'bg-red-500/20 text-red-500'
              }`}>
              <Activity className="w-6 h-6" />
            </div>
            <div>
              <p className="text-sm text-gray-400">System Status</p>
              <p className={`text-2xl font-bold ${systemStatus === 'Healthy' ? 'text-[#1dff00]' : 'text-red-500'
                }`}>{systemStatus}</p>
            </div>
          </div>
        </motion.div>
