...
- Template: set metadata.template to the design that best fits this candidate. Choose exactly one of the available templates: "linton" (light editorial cream layout), "kumar" (dark bento-grid layout), "micah" (dark charcoal-and-gold layout), "smith" (coral two-column with dark sidebar), "clarke" (light lime bento cards), "mercado" (playful pink Memphis-pop), "anderson" (retro mint pixel-desktop), "rosca" (bold editorial fashion, cream & dark), or "laurent" (cream editorial with a giant rotated vertical name). Do not use any other value.
