-- Fix credit deduction functions - use correct column names and transaction type

-- Drop and recreate job search credits function
...
BEGIN
    ...
    -- Record the transaction (use 'type' not 'transaction_type', use 'consumed' not 'spent')
...
-- Drop and recreate auto apply credits function
