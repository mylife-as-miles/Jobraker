-- Fix consume_chat_message RPC to dynamically check for columns on credit_transactions (type vs transaction_type, balance_before)
        ...
        IF v_has_type_col THEN
            ...
            ELSE
                INSERT INTO public.credit_transactions (
                    ...
                    p_user_id, 'consumed', 1, v_new_balance,
                    'AI chat message', 'ai_chat'
                );
            END IF;
        ELSE
